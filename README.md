...
- **Trabalho Prático 1**  
Introdução a Redes de Computadores e a sua importância nos vários sectores de atividade.

  📄 [Enunciado TP1](TP1/enunciado_tp1.pdf)  
  📝 [Apresentação TP1](TP1/relatório_fase_1.pdf)

- **Trabalho Prático 2**  
Análise do comportamento do protocolo IP numa topologia simulada.
...
- **Trabalho Prático 3**  
Compreensão do funcionamento de redes Ethernet e Wifi e do protocolo ARP.
...
- **Assignment 1**  
Introduction to Computer Networks and their importance in various sectors of activity.

  📄 [Statement TP1](TP1/enunciado_tp1.pdf)  
  📝 [TP1 Presentation](TP1/relatório_fase_1.pdf)

- **Assignment 2**  
Understanding the behavior of the IP protocol in a simulated topology.
...
- **Assignment 3**  
Understanding the functioning of Ethernet and Wifi networks and the ARP protocol.
